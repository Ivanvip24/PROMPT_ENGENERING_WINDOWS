...
## Purpose
Pre-designed compositional structures to choose from instead of inventing layout each time. Speeds up design process from 10+ minutes to 1 minute for composition selection.
...
Each framework is a **starting point**, adapt to specific elements:
